	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, course := range course.Courses {
			...
			if course.ApplicationsCount < course.Capacity {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<button @mouseenter=\"hoverButton = true\" @mouseleave=\"hoverButton = false\" class=\"bg-primary-600 text-white rounded-md px-2 py-2 hover:bg-primary-400 w-40\"><span x-show=\"!hoverButton\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/courses/templates/course-tile.templ`, Line: 68, Col: 85}
				}
