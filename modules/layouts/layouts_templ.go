...
func BaseLayoutEx(isAuthenticated bool, isAdmin bool, canSeeVisitors bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isAuthenticated {
			...
			templ_7745c5c3_Err = AuthenticatedLayout(isAdmin, canSeeVisitors).Render(templ.WithChildren(ctx, templ_7745c5c3_Var5), templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			...
			templ_7745c5c3_Err = AnonymousLayout().Render(templ.WithChildren(ctx, templ_7745c5c3_Var6), templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func BaseLayoutWithComponent(cmp templ.Component, isAuthenticated bool, isAdmin bool, canSeeVisitors bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = BaseLayoutEx(isAuthenticated, isAdmin, canSeeVisitors).Render(templ.WithChildren(ctx, templ_7745c5c3_Var8), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func BaseLayoutWithComponentEx(cmp templ.Component, isAuthenticated bool, isAdmin bool, canSeeVisitors bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = BaseLayoutEx(isAuthenticated, isAdmin, canSeeVisitors).Render(templ.WithChildren(ctx, templ_7745c5c3_Var10), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
